...
input=(
  ...
  '
  'Spawn' 'sleep 10; rosservice call /mrs_drone_spawner/spawn "$UAV_NUMBER $UAV_TYPE --enable-rangefinder"
  '
  'Status' 'sleep 15; roslaunch mrs_uav_status status.launch
  '
  'Control' 'sleep 20; roslaunch mrs_uav_general core.launch config_uav_manager:=./custom_configs/uav_manager.yaml
  '
  ...
  'rviz' 'sleep 15; roslaunch mrs_uav_testing rviz.launch
  '
